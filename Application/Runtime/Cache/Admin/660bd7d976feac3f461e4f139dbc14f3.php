...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('Press/doadd');?>" enctype="multipart/form-data">  
      <div class="form-group">
        <div class="label">
          <label>出版社名：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="" name="pressname" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
