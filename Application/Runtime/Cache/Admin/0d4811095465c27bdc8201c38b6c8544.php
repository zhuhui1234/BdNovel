...
<div id="mian" class="panel admin-panel">
    <div class="panel-head"><strong><span class="icon-pencil-square-o"></span> 读者信息</strong></div>
    <div class="container">
        <div class="row" style="margin-top:30px">
            ...
            <div class="col-lg-6">
                ...
                <div class="input-group">
                  <input type="text" id="name" value="" class="form-control" name="readername" placeholder="搜索读者">
        ...
        <table class="table table-hover mt20 table-bordered table-hover">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <a href="<?php echo U('Reader/detail',array('id'=>$val['id']));?>" class="btn btn-success">详情</a>
                    <?php if($val["status"] == '0'): ?><a href="<?php echo U('Reader/forbidden',array('id'=>$val['id']));?>" class="btn btn-danger">禁用</a>
                    <?php else: ?><a href="<?php echo U('Reader/release',array('id'=>$val['id']));?>" class="btn btn-success">解禁</a><?php endif; ?>
                </td>
