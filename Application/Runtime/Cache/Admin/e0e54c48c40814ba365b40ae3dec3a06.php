...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-key"></span> 修改节点信息</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('Node/save');?>">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mname" size="50"  value="<?php echo ($vo["mname"]); ?>" data-validate="required:请输入说明" />       
        </div>
      </div>  
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" name="aname" size="50"  value="<?php echo ($vo["aname"]); ?>" data-validate="required:请输入说明" />       
        </div>
      </div>     
      <div class="form-group">
