  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center" id="tablelist">
      ...
      <?php if(is_array($book)): $i = 0; $__LIST__ = $book;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><div class="button-group"> <a class="button border-main" href='<?php echo U("reduction?id=$vo[id]");?>'><span class="icon-edit"></span> 还原</a> <a class="button border-red" href='<?php echo U("Recycle/del?id=$vo[id]");?>'><span class="icon-trash-o"></span> 删除</a> </div></td>
