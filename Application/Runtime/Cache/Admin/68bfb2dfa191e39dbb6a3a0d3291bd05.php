  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Press/add');?>"> 添加内容</a> </li>
        <li>
          <input id="pressname" value="" type="text" placeholder="请输入出版社关键字" class="input" style="width:250px; line-height:17px;display:inline-block" />
    ...
    <table class="table table-hover text-center" id="tablelist">
      ...
      <?php if(is_array($press)): $i = 0; $__LIST__ = $press;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          <td><?php echo ($vo["id"]); ?></td>
          <td><?php echo ($vo["pressname"]); ?></td>
          <td><img src="/BdNovel/Upload/press/<?php echo ($vo["pic"]); ?>" alt="" width="162" height="54" /></td>
...
<script>
    $('#search').click(function(){
        var where = $('#pressname').val();
        $.ajax({
            type:'get',
            url:'<?php echo U('Press/index');?>',
            data:"pressname="+where,
