...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('Author/update');?>" enctype="multipart/form-data"> 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($data["authorname"]); ?>" name="authorname" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <img src="/BdNovel/Upload/author/<?php echo ($data["pic"]); ?>" alt="" class="margin-left" width="100" height="150" id="url1">
