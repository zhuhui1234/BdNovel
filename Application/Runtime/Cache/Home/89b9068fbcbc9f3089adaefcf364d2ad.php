...
<div class="read-hd-ad">
	...
	<div class="clearfix" style="height:290px;width:980px;margin:0 auto;">
		<img src="/BdNovel/Upload/link/<?php echo ($pic); ?>" alt="">
	</div>
	<div class="clearfix" style="height:auto;width:980px;margin:20px auto;border-left:1px solid #E7E7E7">
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="width:195px;height:340px;border-right:1px solid #E7E7E7;border-bottom:1px solid #E7E7E7;float:left">
				<a href="<?php echo U('Index/detail',array('id'=>$vo['id']));?>" target="_blank"><img src="/BdNovel/Upload/book/<?php echo ($vo["bookpic"]); ?>" alt="" width="127px" height="170px" style="margin:50px auto 0 30px;"></a>
				<span style="display:block;width:127px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;margin:10px auto 0 30px"><a href="<?php echo U('Index/detail',array('id'=>$vo['id']));?>" style="font-size:15px;" target="_blank"><?php echo ($vo["bookname"]); ?></a></span>
				...
				<p style="display:block;width:127px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;margin:20px auto 0 30px;font-size:15px;color:#ff5d56">￥ <?php echo ($vo["price"]); ?><b class="yasuo"></b></p>
