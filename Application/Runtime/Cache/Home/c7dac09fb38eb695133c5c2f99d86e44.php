...
<div class="container clearfix">
		...
		<div class="book fr" style="height:auto;">
			<span style="width:97%;height:40px;display:block;" id="tablelist">
					<table class="table table-striped table-hover table-bordered text-center">
						...
						<?php if($order != null): if(is_array($order)): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							<td><?php echo ($vo["id"]); ?></td>
							<td>￥<?php echo ($vo["total"]); ?></td>
							<td><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
							<td width="200px"><a href="<?php echo U('Person/detail',array('orderid'=>$vo['id']));?>" class="btn btn-primary">详情</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="del()" class="btn btn-danger">删除</a></td>
						</tr><?php endforeach; endif; else: echo "" ;endif; ?>
						<tr>
							<td colspan="5"><div class="pages" value="" id="pages"><?php echo ($page); ?></div></td>
						</tr>
						<?php else: ?>
						<tr>
							<td colspan="4">
	...
	<script>
		...
		function del(){
			$.ajax({
	            type:'post',
	            url:'<?php echo U('Person/delorder');?>',
